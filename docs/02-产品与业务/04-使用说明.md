...
更新时间：2026-08-18 18:40（Asia/Shanghai）
...
| 群聊未 @ | 忽略 |
| 群聊已 @ | 不用绑定，任何人都可以下任务 |
| 私聊 · 扫码用户 | 微信 / 飞书 / Lark / QQ 扫码者自动放行 |
| 私聊 · 其他人 | 出现在设置页待批准；不批准就不能对话 |
| 扫码不返回身份 | 钉钉 / 企微快捷绑定只返回机器人凭据，扫码者仍需批准 |
| 手动凭据渠道 | Telegram，以及手动填写凭据的钉钉 / 企微 / QQ，所有私聊都要先批准 |

## 在 IM 里对话

微信 / 飞书 / Lark / QQ 扫码用户私聊可直接发文字。钉钉 / 企微扫码接口不返回扫码者身份，因此扫码者首次私聊也要先到「设置 → IM助理」批准。群聊必须 @ 机器人，否则不会回复。
...
必须由白名单用户在私聊里回复。群聊里回「批准」无效。不能跨聊天批准。超时后交给本机处理。

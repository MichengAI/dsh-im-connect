                    ...
                    open && h("div", { className: "ima-account-list" },
                      ...(ch.accounts || []).map((account) => h("div", { key: account.id, className: "ima-account-row" },
                        ...
                        h("div", { className: "ima-account-receive", title: t("account.receiveDescription") },
                          ...
                          h("button", { type: "button", className: (account.receiveConfigured ?? account.receiveEnabled) ? "ima-switch" : "ima-switch off", role: "switch", "aria-checked": Boolean(account.receiveConfigured ?? account.receiveEnabled), "aria-label": accountLabel(account, t) + " · " + t("account.receive"), disabled: Boolean(busy[account.id]), onClick: () => onAction(account.id, "receive", { receiveEnabled: !(account.receiveConfigured ?? account.receiveEnabled) }) }, h("i"))),

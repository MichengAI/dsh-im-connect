...
export function imageMedia(data, maxBytes = MAX_CHANNEL_IMAGE_BYTES) {
...
export function fileMedia(data, name = 'file.bin', maxBytes = 20 * 1024 * 1024) {
    if (!data.length || data.length > maxBytes)
        throw new Error('文件为空或超过大小限制');

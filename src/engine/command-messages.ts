...
export const commandEnglish = {
  ...
  "本次处理已结束，但部分回复或文件未能发送。请在网页查看完整结果；不会自动重复执行任务。": "This turn ended, but some responses or files could not be delivered. View the full results on the web. The task will not be run again automatically.",
